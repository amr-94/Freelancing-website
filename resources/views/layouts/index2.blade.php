        ...
        <div class="container search-box rounded">
            <form action="#" id="search-box_search_form_3"
                ...
                <div class="d-flex flex-row align-items-center justify-content-start inline-block">
                    ...
                    <input class="search-box_search_input" placeholder="Search Keyword" required="required"
                        type="search">
                    ...
                    <input class="search-box_search_input " placeholder="Location" required="required"
                        type="search">
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 max-width-50">
                    <div class="box background-color-white-light">
                        ...
                        <h6 class="font-color-black">Education & Training</h6>
                        <a href="#" class="button job_post" data-hover="View Jobs"
                            data-active="I'M ACTIVE"><span>36 Job Posts</span></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 max-width-50">
                    <div class="box background-color-white-light">
                        ...
                        <h6 class="font-color-black">Sales and Marketing</h6>
                        <a href="#" class="button job_post" data-hover="View Jobs"
                            data-active="I'M ACTIVE"><span>72 Job Posts</span></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 max-width-50">
                    <div class="box background-color-white-light">
                        ...
                        <h6 class="font-color-black">Computer Programing</h6>
                        <a href="#" class="button job_post" data-hover="View Jobs"
                            data-active="I'M ACTIVE"><span>42 Job Posts</span></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 max-width-50">
                    <div class="box background-color-white-light">
                        ...
                        <h6 class="font-color-black">Customer Support</h6>
                        <a href="#" class="button job_post" data-hover="View Jobs"
                            data-active="I'M ACTIVE"><span>18 Job Posts</span></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 max-width-50">
                    <div class="box background-color-white-light">
                        ...
                        <h6 class="font-color-black">Design & Multimedia</h6>
                        <a href="#" class="button job_post" data-hover="View Jobs"
                            data-active="I'M ACTIVE"><span>48 Job Posts</span></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 max-width-50">
                    <div class="box background-color-white-light">
                        ...
                        <h6 class="font-color-black">Web Development</h6>
                        <a href="#" class="button job_post" data-hover="View Jobs"
                            data-active="I'M ACTIVE"><span>94 Job Posts</span></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 max-width-50 margin-left-18">
                    <div class="box background-color-white-light">
                        ...
                        <h6 class="font-color-black">Medical/Pharma</h6>
                        <a href="#" class="button job_post" data-hover="View Jobs"
                            data-active="I'M ACTIVE"><span>64 Job Posts</span></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 max-width-50">
                    <div class="box background-color-white-light ">
                        ...
                        <h6 class="font-color-black">Engineer/Architects</h6>
                        <a class="button job_post" data-hover="View Jobs" data-active="I'M ACTIVE"><span>52 Job
                                Posts</span></a>
                    </div>
                </div>
            </div>
        ...
        <div class="container text-center">
            ...
            <div class="detail">
                <div class="media display-inline text-align-center">
                    ...
                    <div class="media-body text-left  text-align-center">
                        <h6> <a href="#" class="font-color-black">Jopitar looking for a senior UX Designer</a>
                        </h6>
            ...
            <div class="detail">
                <div class="media display-inline text-align-center">
                    ...
                    <div class="media-body text-left text-align-center">
                        <h6><a href="#" class="font-color-black">Mshape looking for a senior UX Designer</a>
                        </h6>
                        <i class="large material-icons">account_balance</i>
                    ...
                    <div class="owl-carousel Featuread-Company-carousel">
                        <a href="#" class="Featuread-Company-item">
                            <div class="media text-align-center  media1">
                                <img src="imags/job-post-icone-3.png" alt="John Doe"
                        ...
                        <a href="#" class="Featuread-Company-item">
                            <div class="media  text-align-center  media1">
                                <img src="imags/job-post-icone-4.png" alt="John Doe"
                                    class="margin-auto Featuread-Company-img">
                                <div class="media-body text-left text-align-center">
                        ...
                        <a href="#" class="Featuread-Company-item">
                            <div class="media text-align-center   media1">
                                <img src="imags/job-post-icone-1.png" alt="John Doe"
                                    class=" Featuread-Company-img margin-auto">
                                <div class="media-body text-left text-align-center">
                        ...
                        <a href="#" class="Featuread-Company-item">
                            <div class="media   text-align-center media1">
                                <img src="imags/job-post-icone-5.png" alt="John Doe"
                                    class=" Featuread-Company-img margin-auto">
                                <div class="media-body text-left text-align-center">
